...
def main():
    ...
    nodes = nx.draw_networkx_nodes(G, fix_position, node_size=100, node_color='blue')
    edges = nx.draw_networkx_edges(G, fix_position, node_size=100, arrowstyle='->',
                                arrowsize=10, edge_color='b',
                                edge_cmap=plt.cm.Blues, width=2)
    nx.draw_networkx_labels(G, fix_position, font_size=30, font_family='sans-serif')
